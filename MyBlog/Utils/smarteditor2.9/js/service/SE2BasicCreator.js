...
function createSEditor2(elIRField, htParams, elSeAppContainer){
	...
	var htDimension = {
		nMinHeight:205,
		nMinWidth:parseInt(elIRField.style.minWidth, 10)||720,
	...
	oEditor.registerPlugin(new nhn.husky.SE2M_ImageLink(elAppContainer)); 			   // 이미지 링크
	oEditor.registerPlugin(new nhn.husky.SE2M_PreviewDocument(elAppContainer));		   // 미리보기
